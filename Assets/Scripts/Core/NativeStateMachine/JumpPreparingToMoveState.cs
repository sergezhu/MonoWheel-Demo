...
{
    public class JumpPreparingToMoveState : IState
    {
        ...
        public JumpPreparingToMoveState(AnimationController animationController, AccelerationProvider accelerationProvider, MotorMono motorMono, JumpPower jumpPower, Movement movement)
        {
